...
# startdev.sh — Start Spore OS local development environment on macOS
...
[[ -f "$SPORE_DATA_DIR/spored" ]] || die "spored binary not found in $SPORE_DATA_DIR. Run './macos/develop.sh' first!"
